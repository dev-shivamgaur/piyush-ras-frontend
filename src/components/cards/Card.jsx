...
export default function Card({ data }) {
  return (
    <Link to={`/read/?k=${data?._id}`}>
      ...
      <div className="group  from-[#f7c17c] to-[#e6a85c] border border-[#8A5A22] rounded-xs overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
